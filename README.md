...
> **Customized it to support delegates from JSQMessagesViewController, rest all is same.** More screenshots available at [CocoaControls](https://www.cocoacontrols.com/controls/jsqmessagesviewcontroller)
